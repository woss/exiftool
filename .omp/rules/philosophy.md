---
name: code-philosophy-gate
description: Mandatory philosophy-skill loading before any code change in this repo
alwaysApply: true
---
...
2. **Load the skill** by reading `skill://frontend-philosophy` / `skill://code-philosophy` BEFORE implementation
